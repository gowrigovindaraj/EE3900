...
\begin{lstlisting}
$ wget https://raw.githubusercontent.com/gowrigovindaraj/EE3900/main/Pingala/1.py
\end{lstlisting}
...
Download the Python code using
\begin{lstlisting}
$ wget https://raw.githubusercontent.com/gowrigovindaraj/EE3900/main/Pingala/2_1.py
\end{lstlisting}


\begin{figure}[!htp]
   \includegraphics[width=\columnwidth]{2_1.pdf}
    \caption{Plot of $x(n)$}
    \label{fig:xn}
\end{figure}
...
Download the Python code using
\begin{lstlisting}
$ https://raw.githubusercontent.com/gowrigovindaraj/EE3900/main/Pingala/2_2.py
\end{lstlisting}


\begin{figure}[!htbp]
    \includegraphics[width=\columnwidth]{2_2.pdf}
    \caption{Plot of $y(n)$}
    \label{fig:yn}
\end{figure}
\item Find $Y^{+}(z)$. 
